...
extension UIFont {
    ...
    static func appleSDGothicNeo35() -> UIFont? {
        return UIFont.init(name: "Apple SD Gothic Neo", size: 35)
    }
    
    static func appleSDGothicNeo15() -> UIFont? {
        return UIFont.init(name: "Apple SD Gothic Neo", size: 15)
    }
